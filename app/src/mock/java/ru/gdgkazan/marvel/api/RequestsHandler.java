...
public class RequestsHandler {
    ...
    private final static String API_URL = "/v1/public";


    public RequestsHandler() {
        mResponsesMap.put(API_URL + "/comics", "comics.json");
        mResponsesMap.put(API_URL + "/comics/1", "single_comics.json");
        mResponsesMap.put(API_URL + "/user/repos", "repositories.json");
    }
